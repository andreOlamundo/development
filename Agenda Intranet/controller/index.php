...
<html lang="pt-br" class="no-js">
  <head>
    ...
    <meta http-equiv="refresh" content="1; URL= http://192.168.1.3/intranetSDB_teste">
    <meta charset="UTF-8">
...
<div id='menu' class="col-sm-3 col-sm-2 sidebar">
          <ul class="nav nav-sidebar">
           <li><a href='instancias.php?cod=1'>INSTITUCIONAL</a></li>
            <li><a href='instancias.php?cod=2'>FORMULÁRIOS</a></li>
            <li><a href='instancias.php?cod=4'>POLITICAS & PROCEDIMENTOS</a></li>    
             <li><a href='instancias.php?cod=5'>LISTA DE CONTATOS</a></li>
            <li><a href='instancias.php?cod=6'>AGENDA</a></li>
            <li><a href='instancias.php?cod=6.1'>LOCALIZAÇÃO</a></li>
            <li><a href='instancias.php?cod=7'>UTILIDADES</a></li>
               <li><a href='instancias.php?cod=8'>GALERIA DE FOTOS</a></li>
               <li><a href='instancias.php?cod=9'>NEW CADASTRO</a></li>  
...
<footer style="position: absolute; margin-top: 50%; margin-left: 35%; "><a href="#myPage" title="To Top">
  ...
  <p>&copy; 1976, 2017 SANRIO CO., LTD. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
</footer>
