...
/*case '2.1'; // Direto pelo ..views/login_in/index.php.
 Menu:Sidebar carrega <a href='index.php?cod=2.1'>*/
...
include('../views/login_in/table_list.php');
break;
...
case '12'; // Aqui tambem, lá é page.php?cod=8.4, então ela carregará o médoto que busca as imagens diadafamilia2016php.'div conteúdo'
include('../views/login_in/table_list_Adm_iframe.php');

break;

case '27'; // Aqui tambem, lá é page.php?cod=5, então ela carregará a página de table_list.html.'div conteúdo'.
include('views/login_out/table_list.php');
break;
