...
$RF10_VALORITEM = str_replace(",",".",$_POST["RF10_VALORITEM"]);

if(is_array($RF10_VALORITEM) ){
 	foreach($RF10_VALORITEM as $item => $RF10_VALORITEM)
 	{
		for( $item=$item; $item<count($RF10_VALORITEM); $item++ )
{
...
$RF10_DDITEM =$_POST['RF10_DDITEM'][$item];
	...
	$RF10_VALORITEM =$_POST['RF10_VALORITEM'][$item].$query = "INSERT INTO `formpar_item`(`RF3_NUMEROPAR`, `RF10_VALORITEM`, `RF10_DATAITEM`, `RF10_DDITEM`) VALUES ('".$RF3_NUMEROPAR."', '".$RF10_VALORITEM."', '".$RF10_DATAITEM."', '".$RF10_DDITEM."')";
