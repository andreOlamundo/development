...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <img class="img-responsive" src="/intranetSDB/images/logo-sanrio-top.png" width="120" height="26" style="position: absolute; left: 40px; top: 10px;" >
    ...
    <ul class="nav navbar-nav navbar-right">    
        ...
        <span class="navbar-brand">Olá: <?php echo $_SESSION['user_namecolab']; ?></span><span class="navbar-brand">|</span>
...
<div id='menu' class="col-sm-2 sidebar">
          <ul class="nav nav-sidebar">
           ...
           <li><a href='controller/instancias.php?cod=5'>LISTA DE COLABORADORES</a></li>
           ...
           <li><a href='controller/instancias.php?cod=12'>PAR List</a></li>
          </ul>                          
        </div>
