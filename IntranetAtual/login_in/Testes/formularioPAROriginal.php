 ...
 <head>
   ...
   <script type="text/javascript">
            ...
            function adicionaLinha(idTabela) {
                ...
                celula1.innerHTML = "<iframe id='meuIframe' name='maskinput' src='http://192.168.1.3/intranetSDB_teste/views/login_in/maskMoney.php' style='width: 100% ;height: 50px;'  frameborder = '0' allowfullscreen></iframe>";
