<head>
   ...
   <script type="text/javascript">
            ...
            function adicionaLinha(idTabela) {
                ...
                celula1.innerHTML = "<input type='text' required='required' placeholder='R$ 0,00 ' maxlength='15' name='RF10_VALORITEM[]' onblur='calcular(this)' pattern='([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$' class='valor' size='15' onkeypress='mascara( this, mvalor );'>";
...
/*$('removeLinha').click(function() {
  ...
  if ($(this).is("removeLinha")) {
total-= document.getElementsByClassName('valor');
...
<form id="formpar" name="formpar" method="post" action="model\classes\Registropar.php" enctype="multipart/form-data">
  ...
  <label for="RF10_PDPROJETO">Previsão de desembolso do Projeto</label>        
     <table class="table table-bordered" id="tbl" border="0"> 
        ...
        <tr>
    	  ...
    	  <input type="text" required="required" class="form-control" placeholder="R$ 0,00" name="RF10_VALORTOTAL" id="result" value="0,00" readonly>
 	      </td>
 	      <td>
...
<!-- Post User atual -->
 <input type="hidden" name="user" value='<?php echo $_SESSION['user_namecolab']; ?>'/>
