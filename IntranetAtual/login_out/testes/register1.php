...
<form method="post" action="views/login_out/register.php" name="registerform">
...
?>
    ...
    <input id="login_input_ramal" class="form-control" type="text" class="form-control" name="user_ramal" required />
