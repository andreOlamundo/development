...
$availCatStr = translate ( 'Entradas Disponíveis' );
...
echo '
    <table align="center" border="0" width="90%">
      <tr>
        <th colspan="3">' . translate ( 'Local' ) . '</th>
      </tr>
...
echo '
 ...
 . '" onclick="selRemove()" />
      ...
      <tr>
        <td valign="top" align="right">*' . translate ( 'Salas disponíveis' )
