...
<!-- DETAILS -->
  ...
  echo ( ! empty ( $categories ) && $CATEGORIES_ENABLED == 'Y' ? '
     ...
     . '" valign="top">
                      <label for="entry_categories">' . translate ( 'Locais' )
     . ':<br /></label>

     <td class="input"  align="left" valign="top" width="100%" >
                      <input type="button" value="' . translate ( 'Selecionar...' )
...
<input readonly="readonly" type="text" name="catnames" '
  ...
  echo '
            ...
            <tr>
              <td class="tooltip" title="' . tooltip ( 'location-help' )
     . '"><label form action="entry_location">' . translate ( 'Location' )
     . ':</label></td>
     <td width="0%">
              <select name="location" id="entry_location" multiple> 
              <option value="Sala Pequena">Sala Pequena</option>
