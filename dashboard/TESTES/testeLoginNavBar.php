    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <form class="navbar-form navbar-right" name="login_form" id="login" action="login.php" method="post"
  onsubmit="return valid_form( this )">
  <?php
if ( ! empty ( $return_path ) ) {
  echo '<input type="hidden" name="return_path" value="' .
...
?>
            <div class="form-group">
              <input type="text" placeholder="Email" class="form-control" name="login" id="user" size="15" maxlength="25"
   value="<?php if ( ! empty ( $last_login ) ) echo $last_login;?>"
   tabindex="1" />
            </div>
            <div class="form-group">
              <input type="password" placeholder="Password" class="form-control" name="password" id="password" type="password" size="15"
   ...
   <?php etranslate ( 'Lembrar minhas credencias' )?></label>
            </div>
            <button type="submit"  class="btn btn-success" value="<?php etranslate ( 'Login' )?>" tabindex="4" />Sign in</button>
          </form>
        </div>
        <?php }
...
<hr>
<p class="text-center"><small>&copy 1976, 2016 SANRIO CO., LTD.</small></p>
...
?>
     ...
     <!--   <div id="myNavbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="/intranetSDB/dashboard/marketing.html">MARKETING</a></li>
            <li><a href="/intranetSDB/dashboard/designer.html">DESIGNER</a></li>                       
          </ul>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
           <li><a href="/intranetSDB/dashboard/index.html">INSTITUCIONAL</a></li>
            <li><a href="/intranetSDB/dashboard/formulario.html">FORMULÁRIOS</a></li>
            <li><a href="/intranetSDB/dashboard/politicasProcedimentos.html">POLITICAS & PROCEDIMENTOS</a></li>    
             <li><a href="/intranetSDB/dashboard/table_list.php">LISTA DE RAMAIS</a></li>
            <li><a href="/intranetSDB/dashboard/agenda.html">AGENDA</a></li>
            <li><a href="/intranetSDB/dashboard/utilidades.html">UTILIDADES</a></li>
            <li><a href="/intranetSDB/dashboard/marketing.html">MARKETING</a></li>
            <li><a href="/intranetSDB/dashboard/designer.html">DESIGNER</a></li>         
          </ul>
