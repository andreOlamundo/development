          ...
          <ul class="nav nav-sidebar">
           <li><a href="dashboard/institucional.html">INSTITUCIONAL</a></li>
            ...
            <li><a href="dashboard/politicasProcedimentos.html">POLITICAS & PROCEDIMENTOS</a></li>    
             <li><a href="dashboard/interact/table_list_Adm.php">LISTA DE RAMAIS</a></li>
...
$consulta = "SELECT * FROM webcal_user  ORDER BY cal_firstname ASC";
...
<a href="#cadastro_lr"><button type="button" class="btn btn-primary btn-xs">ALTERAÇÃO DE CADASTRO:</button></a>
