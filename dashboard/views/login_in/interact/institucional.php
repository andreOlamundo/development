...
<a href="interact/cadastro_lr.php"><button type="button" class="btn btn-primary">CADASTRAR</button></a>
<a href="interact/controle_lr.php"><button type="button" class="btn btn-warning">ALTERAR/EXCLUIR</button></a>
