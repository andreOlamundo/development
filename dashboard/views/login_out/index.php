  ...
  <img class="img-responsive" src="/intranetSDB/images/logo-sanrio-top.png" width="120" height="26" style="position: absolute; left: 40px; top: 10px;" >
        ...
        <div id="mynavbar" class="navbar-collapse collapse">
            ...
            <div class="form-group">
              <input id="login_input_username" type="text" placeholder="Usu�rio" class="form-control login_input" name="user_name" required>
            </div>
            <div class="form-group">
...
<div id='menu' id="mynavbar" class="col-sm-3 col-sm-2 sidebar">
