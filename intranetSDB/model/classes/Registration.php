        ...
        elseif (!empty($_POST['user_name'])
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($query_check_user_name->num_rows == 1) {
                    $this->errors[] = "Desculpe, esse nome de usuário ou endereço de e-mail já possuem cadastro ativo, tente novamente, ou se já possuí cadastro, entre com Usuário e Senha em: ACESSO RESTRITO .";
                } else {
                    // write new user's data into database
                    $sql = "INSERT INTO users (user_name, user_password_hash, user_sobrenome, user_email, cod_depto, cod_cargo, user_ramal)
                            VALUES('" . $user_name . "', '" . $user_password_hash . "','" . $user_sobrenome . "', '" . $user_email ."','" . $cod_depto . "','" . $cod_cargo . "','" . $user_ramal . "');";
