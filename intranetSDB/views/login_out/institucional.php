...
<div data-target="#home" class="container-fluid">
  <div class="row">
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
 
<h2>Institucional <span class="glyphicon glyphicon-globe"></span></h2>
...
<hr class="featurette-divider">
 ...
 <div class="row text-center">
          <div class="col-sm-4">
          <div class="thumbnail">
          <img src="/intranetSDB/images/institucional/20170221_0917012.jpg" width="120" height="26" alt="SANRIO">
          <h2>Visão </h2>
          <p>A visão da Sanrio, é promover "comunicação social" por meio de criatividade e inovação, compartilhando felicidade, amizade e diversão.</p>
        ...
        <div class="col-sm-4">
        <div class="thumbnail">
        <img src="/intranetSDB/images/institucional/20170221_0914112.jpg" width="120" height="26" alt="SANRIO">
          <h2>Missão</h2>
          <p>A missão da Sanrio, é criar e desenvolver propriedades intelectuais originais, coloca-las em prática com uma variedade de produtos de qualidade, e prestar serviços praticando atividades que inspirem nossos consumidores a terem experiências únicas e exclusivas no mundo todo.</p>
         ...
         <div class="col-sm-4">
         <div class="thumbnail">
         <img src="/intranetSDB/images/institucional/20170214_1335002.jpg" width="120" height="26" alt="SANRIO">
          <h2>Valores</h2>
          <p>Felicidade, Amizade, Comprometimento, Respeito, Transparência, Ética e Confiança.</p>
                    </div><!--/ .thumbnail-->
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->

<p>"...Seres humanos precisam uns dos outros. Nós nos ajudamos a sobreviver e a levar uma vida cheia de sentido. Acreditamos e dependemos de nossos companheiros. Talvez seja isto a felicidade".
            </p>
              <blockquote>
